...
def admin_page(body, title="Dashboard", active="dashboard", admin_path="admin", pending_requests=0):
    ...
    nav_items = [
        ...
        ("search", f"/{admin_path}/search", "🔍", "Search"),
        ("_section", "", "MANAGE"),
        ("channels", f"/{admin_path}/channels", "📺", "Channels"),
        ("plans", f"/{admin_path}/plans", "💎", "Plans"),
        ("ads", f"/{admin_path}/ads", "📢", "Ads"),
        ("queue", f"/{admin_path}/queue", "📦", "Upload Queue"),
        ("_section", "", "ANALYTICS"),
        ("logs", f"/{admin_path}/analytics", "📈", "Analytics"),
        ("downloads", f"/{admin_path}/downloads", "📥", "Downloads"),
        ("_section", "", "BILLING"),
        ("requests", f"/{admin_path}/requests", "📩", "Requests"),
        ("payments", f"/{admin_path}/payments", "💰", "Payments"),
        ("_section", "", "SYSTEM"),
        ("roles", f"/{admin_path}/roles", "🛡️", "Roles"),
        ("audit", f"/{admin_path}/audit", "📜", "Audit Logs"),
        ("backups", f"/{admin_path}/backups", "💾", "Backups"),
        ("import-export", f"/{admin_path}/import-export", "📤", "Import/Export"),
        ("api-docs", f"/{admin_path}/api-docs", "📡", "API Docs"),
        ("plugins", f"/{admin_path}/plugins", "🔌", "Plugins"),
        ("settings", f"/{admin_path}/settings", "⚙️", "Settings"),
        ("health", f"/{admin_path}/health", "🏥", "Health"),
        ("errors", f"/{admin_path}/errors", "🐛", "Errors"),
    ]
    nav_html = ""
